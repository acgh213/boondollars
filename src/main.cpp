...
uint256 hashGenesisBlock("0x33ae37bac6d2a2ea2ae0f9b3ad947f52ef520b2eb2096e494c85a12eaaaa7952");
...
const string strMessageMagic = "Boondollar Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // Boondollar: 1 days
static const int64 nTargetSpacing = 0.25 * 60 * 60; // Boondollar: 0.25 hours
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal boondollar miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Boondollar", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        assert(block.hashMerkleRoot == uint256("0x534e93717d0f70efa5e67d1e017dc31411a6747dd054ae7975e0642eb82ce3a6"));
